...
class Modflow():
    def __init__(self):
        ...
        self.Lx = 256.  # Length in x direction
        self.Ly = 256.  # Length in y direction
        self.ztop = 0.  # Top elevation of the layer
        self.zbot = -1.  # Bottom elevation of the layer
        self.nlay = 1  # number of layers
        self.nrow = 256  # number of rows (number of grid nodes in y direction)
        self.ncol = 256  # number of columns (number of grid nodes in x direction)
        self.wcol = 128  # x index for the well to discharge or recharge
        self.wrow = 128  # y index for the well to discharge or recharge
